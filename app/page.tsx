...
import { CheckCircle, Star, ChevronRight, ArrowRight, ShieldCheck, Clock, Briefcase, Phone, DollarSign, HandsClapping, Award, Users, BadgeCheck } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        {/* Task Categories Banner */}
        <section className="bg-blue-50 py-6">
          <div className="container">
            <div className="flex flex-wrap justify-center gap-4 md:gap-8">
              {["Furniture Assembly", "Home Cleaning", "Delivery", "Gardening", "Handyman", "Moving", "Tech Help", "Pet Care"].map((category, i) => (
                <Link href="#" key={i} className="text-sm font-medium text-blue-700 hover:text-blue-900 hover:underline">
                  {category}
                </Link>
              ))}
            </div>
        ...
        <section className="bg-gray-50 py-16">
          <div className="container">
            <div className="flex justify-between items-center mb-10">
              <h2 className="text-3xl font-bold text-blue-900">Live Marketplace</h2>
              <Button variant="outline" className="text-blue-600 rounded-md">Browse all tasks</Button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                {
                  title: "Need help assembling IKEA wardrobe",
                ...
                <Card key={i} className="p-5 border-gray-200">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">{task.bids} offers</span>
                    <span className="text-xs text-gray-400">{task.postedTime}</span>
                  </div>
                  <div className="mt-4 pt-4 border-t">
                    <Button variant="outline" className="w-full text-blue-600 rounded-md">View details</Button>
                  </div>
                </Card>
              ))}
            </div>
        ...
        {/* Tasker Highlight Section */}
        <section className="bg-white py-16">
          <div className="container">
            <h2 className="text-3xl font-bold text-blue-900 text-center mb-6">Meet our top Taskers</h2>
            <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
              Our platform is powered by skilled professionals ready to help you with any task. Here are some of our highest-rated Taskers.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                ...
                },
                {
                  ...
                  skills: ["Home Cleaning", "Organization", "Personal Assistant"],
                  rating: 5.0,
                  completedTasks: 517
                },
                {
                  ...
                  skills: ["Handyman", "Electrical", "Painting"],
                  rating: 4.8,
                  completedTasks: 289
                }
              ].map((tasker, i) => (
                <div key={i} className="bg-white rounded-lg border p-6 text-center">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden">
                    <img src={tasker.image} alt={tasker.name} className="w-full h-full object-cover" />
                  </div>
                  <h3 className="text-xl font-semibold text-blue-800 mb-1">{tasker.name}</h3>
                  <div className="flex items-center justify-center mb-3">
                    <Star className="h-4 w-4 text-yellow-400 mr-1" />
                    <span className="text-gray-700">{tasker.rating}/5</span>
                  </div>
                  <div className="mb-4">
                    <p className="text-sm text-gray-500">{tasker.completedTasks} tasks completed</p>
                  </div>
                  <div className="flex flex-wrap justify-center gap-2 mb-4">
                    {tasker.skills.map((skill, j) => (
                      <span key={j} className="px-2 py-1 bg-blue-50 text-blue-700 text-xs rounded-full">
                        {skill}
                      </span>
                    ))}
                  </div>
                  <Button variant="outline" className="w-full text-blue-600">View profile</Button>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="bg-white py-16">
          <div className="container">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-blue-900 text-center mb-12">Our marketplace advantage</h2>
              <div className="space-y-8">
                {[
                  {
                    icon: <Users className="h-8 w-8 text-blue-600" />,
                    title: "Community powered",
                    description: "With over 1 million Taskers, our diverse community has the skills to handle any job.",
                  },
                  {
                    icon: <BadgeCheck className="h-8 w-8 text-blue-600" />,
                    title: "Verified profiles",
                    description: "All Taskers undergo ID verification and review checks before joining our platform.",
                  },
                  {
                    icon: <DollarSign className="h-8 w-8 text-blue-600" />,
                    title: "Competitive pricing",
                    description: "Set your budget and get multiple bids, ensuring you get the right person at the right price.",
                  },
                  // {
                  //   icon: <HandsClapping className="h-8 w-8 text-blue-600" />,
                  //   title: "Satisfaction guaranteed",
                  //   description: "Payment is only released when the task is completed to your satisfaction.",
                  // },
                ].map((benefit, i) => (
        ...
        <section className="bg-gray-50 py-16">
          <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold text-blue-900 mb-4">Download the Fixo app</h2>
              <p className="text-gray-600 mb-6">
                Take Fixo with you wherever you go. Post tasks, chat with Taskers, and manage your jobs all from your phone.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <p className="text-gray-700">Get instant notifications when Taskers bid on your tasks</p>
                </div>
                <div className="flex items-center">
                  <div className="mr-4 bg-blue-100 p-2 rounded-full">
                    <Clock className="h-6 w-6 text-blue-600" />
                  </div>
                  <p className="text-gray-700">Track your Tasker's arrival in real-time</p>
                </div>
                <div className="flex items-center">
                  <div className="mr-4 bg-blue-100 p-2 rounded-full">
                    <Star className="h-6 w-6 text-blue-600" />
                  </div>
                  <p className="text-gray-700">Leave reviews and build your reputation</p>
                </div>
              </div>
              <div className="flex gap-4 space-x-5 mt-8">
                ...
                <img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Get it on Google Play" className="h-10 scale-150" />
              </div>
            </div>
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-5 -left-5 bg-blue-600 text-white rounded-lg p-4 shadow-lg">
                <div className="flex items-center">
                  <Award className="h-8 w-8 mr-3" />
                  <div>
                    <p className="font-bold">Top Rated App</p>
                    <p className="text-sm">4.8/5 on App Store</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-blue-600 py-16">
          <div className="container text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="default" className="text-white border-white hover:bg-blue-700 rounded-md">
                Become a Tasker
              </Button>
            </div>
          </div>
